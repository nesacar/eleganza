...
class SubscribersController extends Controller {
	 ...
	 * @return Response
	 */
	public function store(Requests\CreateSubscriberRequest $request)
	{
	...
	public function edit($id)
	{
		...
		return view('admin.subscribers.edit', compact('slug', 'subscriber'));
	}
	 ...
	 * @return Response
	 */
	public function update(Requests\EditSubscriberRequest $request, $id)
	{
	...
	public function subscribe(Requests\CreateSubscriberRequest $request)
	{
		$sub = Subscriber::create($request->all());
		$sub->verification = str_random(32);
		$sub->update();
