...
<head>
    ...
    <![endif]-->
    <!--[if !mso]><!-->
    <link href="https://fonts.googleapis.com/css?family=Montserrat:300&text=ELGANZ" rel="stylesheet" type="text/css">
    <style type="text/css">
        @import url(https://fonts.googleapis.com/css?family=Montserrat:300&text=ELGANZ);
    </style>
    <!--<![endif]-->
    <style type="text/css">
...
<div style="background-color:#FFF;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:bottom;" width="100%">
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Montserrat;font-size:36px;letter-spacing:0.125em;line-height:1.5;text-align:center;text-transform:uppercase;color:#FFF;">
                                        <a href="{{ url('/') }}" style="color: white; text-decoration: none;">eleganza</a>
                                    </div>
                                </td>
                            </tr>
                        </table>
    ...
    <div style="Margin:0px auto;max-width:600px;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
            <tbody>
            <tr>
                <td style="direction:ltr;font-size:0px;padding:60px 0;text-align:center;vertical-align:top;">
                    <!--[if mso | IE]>
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:bottom;width:100%;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:bottom;" width="100%">
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica;font-size:36px;font-weight:bold;line-height:1;text-align:center;text-transform:uppercase;color:rgba(0, 0, 0, .87);"> vaša narudžba je spremna za dostavu </div>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica;font-size:18px;line-height:1.5;text-align:center;color:rgba(0, 0, 0, .87);"> Vaša je narudžba obrađena i spremna za slanje! </div>
                                </td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:bottom;" width="100%">
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica;font-size:28px;font-weight:bold;line-height:1.5;text-align:left;color:rgba(0, 0, 0, .87);">
                                        <div class="overline" style="width: 80px; height: 4px; margin-bottom: 8px; background-color: #F8333F;"></div> Detalji narudžbe: </div>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;">
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            >
                    <![endif]-->
                    <div class="mj-column-per-75 outlook-group-fix" style="font-size:0;line-height:0;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                        <!--[if mso | IE]>
                        <table  role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                        ...
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                            ...
                                            <tr>
                                                <td style="width:175px;">
                                                    {!! HTML::Image($product->image, $product->title, array('style' => 'border:0;display:block;outline:none;text-decoration:none;width:100%;', 'width' => '175')) !!}
                                                    {{--<img height="auto" src="http://www.s-l.co.rs/images/products/esprit-watches-1917.jpg" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="175">--}}
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                ...
                <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;">
                    ...
                    <div class="mj-column-per-75 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:bottom;width:100%;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tbody>
                            <tr>
                                <td style="border-bottom:1px solid rgba(0, 0, 0, .12);vertical-align:bottom;padding:0 0 60px;">
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div style="font-family:Helvetica;font-size:28px;font-weight:bold;line-height:1.5;text-align:left;color:rgba(0, 0, 0, .87);">
                                                    <div class="overline" style="width: 80px; height: 4px; margin-bottom: 8px; background-color: #F8333F;"></div> Adresa za dostavu: </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div style="font-family:Helvetica;font-size:16px;line-height:1.5;text-align:left;color:rgba(0, 0, 0, .87);">
                                                    <span id="name">{{ $user->customer->name }} {{ $user->customer->lastname }}</span>
                                                    <br>
                                                    <span id="street">{{ $user->customer->address }}</span>
                                                    <br>
                                                    <span id="city">{{ $user->customer->town }}</span>
                                                    <br>
                                                    <span id="state">Hrvatska</span>
                                                    <br>
                                                </div>
                                            </td>
                                        </tr>
    ...
    >
        <tr>
            <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
    <![endif]-->
    <div style="background:#F8333F;background-color:#F8333F;Margin:0px auto;max-width:600px;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#F8333F;background-color:#F8333F;width:100%;">
            <tbody>
            <tr>
                <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;">
                    <!--[if mso | IE]>
                    ...
                    <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:bottom;width:100%;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:bottom;" width="100%">
                                        ...
                                        <tr>
                                            <td style="padding:4px;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-radius:3px;width:32px;">
                                                    <tr>
                                                        <td style="font-size:0;height:32px;vertical-align:middle;width:32px;"> <a href="https://facebook.com/eleganza.hr" style="text-decoration: none; color: inherit;">
                                                                <img height="32" src="https://www.iconsdb.com/icons/preview/white/facebook-5-xxl.png" style="border-radius:3px;" width="32">
                                                            </a> </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-radius:3px;width:32px;">
                                                    <tr>
                                                        <td style="font-size:0;height:32px;vertical-align:middle;width:32px;">
                                                            <a href="https://linkedin.com/eleganza.hr" style="text-decoration: none; color: white;">
                                                                <img height="32" src="https://www.iconsdb.com/icons/preview/white/linkedin-5-xxl.png" style="border-radius:3px;" width="32">
                                                            </a>
                                                        </td>
                                                    </tr>
                                                </table>
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica;font-size:12px;line-height:18px;text-align:center;color:#FFF;"> Copyright &copy; 2018 ELEGANZA </div>
                                </td>
                            </tr>
                        </table>
                    </div>
