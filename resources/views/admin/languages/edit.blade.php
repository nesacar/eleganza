    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                ...
                <div class="form-group">
                    <label for="primary" class="col-sm-2 control-label">Primarni jezik</label>
                    <div class="col-sm-10">
                        {!! Form::checkbox('primary', 1, $language->primary, ['class' => 'switch-state', 'data-on-color' => 'success', 'data-off-color' => 'danger', 'data-on-text' => 'DA', 'data-off-text' => 'NE', 'id' => 'active']) !!}
                    </div>
                </div>
                <div class="form-group">
