        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                <div class="panel-body">
                    <div class="widget">
                        <h3 class="section-title" style="margin-bottom: 15px"><i class="fa fa-area-chart"></i> Statistika za Newsletter: {{ $newsletter->title }}</h3>
                        <div class="col-sm-8">
                            <ul class="nav nav-pills">
                                <li @if(!$search) class="active" @endif><a href="{{ url('admin/statistics/'.$newsletter->id.'/dayNewsletter') }}">Danas</a></li>
