                    ...
                    <div class="widget">
                        ...
                        <div class="col-sm-8">
                            <ul class="nav nav-pills">
                                ...
                                <li @if(!$search) class="active" @endif><a href="{{ url('admin/statistics/'.$newsletter->id.'/lastMonthNewsletter') }}">Prošlog meseca</a></li>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-8 col-sm-6 bordered">
                                        <div class="value-block value-bigger changed-up some-left-padding">
                                            ...
                                            @if($average == 0)
                                                <div class="value-sub">Prosek je manji od jednog klika po danu</div>
                                            @elseif($average%10<4)
                                                <div class="value-sub">Prosek od {{ $average }} klika po danu</div>
                                            @else
                                                <div class="value-sub">Prosek od {{ $average }} klikova po danu</div>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-4 col-sm-6">
                                        ...
                                        @if(\Session::get('search_od') || \Session::get('search_do'))
                                            ...
                                            {!! Form::text('do', \Session::get('search_do'), ['id' => 'do', 'class' => 'form-control input-sm pokazi', 'placeholder' => 'Do']) !!}
                                        @else
...
@section('footer_scripts')
    ...
    @else
        data: [@for($i=1;$i<=$days;$i++) 0, @endfor],
    @endif
    spanGaps: false,
    }
    ]
