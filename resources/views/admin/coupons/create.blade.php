        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(['action' => ['CouponsController@store'], 'method' => 'POST', 'class' => 'form-horizontal']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::text('valid_at', null, array('class' => 'form-control', 'id' => 'valid_at')) !!}
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::checkbox('forever', 1, null, ['class' => 'switch-state', 'data-on-color' => 'success', 'data-off-color' => 'danger', 'data-on-text' => 'DA', 'data-off-text' => 'NE', 'id' => 'forever']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
