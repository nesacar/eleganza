        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title"><i class="fa fa-cubes" style="margin-right: 5px"></i>Podaci o setu</h4>
                </div>
                <div class="panel-body">
                    @include('admin.partials.errors')
                    {!! Form::open(['action' => ['SetsController@store'], 'method' => 'POST', 'class' => 'form-horizontal']) !!}
