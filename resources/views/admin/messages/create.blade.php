        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(['action' => ['MessagesController@store'], 'method' => 'POST', 'class' => 'form-horizontal']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::checkbox('seen', 1, false, ['class' => 'switch-state', 'data-on-color' => 'success', 'data-off-color' => 'danger', 'data-on-text' => 'DA', 'data-off-text' => 'NE', 'id' => 'active']) !!}
                            </div>
                        </div>
                        <hr>
                        <div class="form-group">
