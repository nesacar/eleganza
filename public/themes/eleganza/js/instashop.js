...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__instashop_index_js__ = __webpack_require__(256);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modal__ = __webpack_require__(257);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_siema__ = __webpack_require__(258);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shop__ = __webpack_require__(259);
...
function init() {
  ...
  __WEBPACK_IMPORTED_MODULE_0_moment___default.a.locale('hr');
...
function _render() {
  ...
  if (state.open && state.data) {
    ...
    $date.innerHTML = __WEBPACK_IMPORTED_MODULE_0_moment___default()(state.data.created_at).format('LL');
    // Setup Siema.
    slider = new __WEBPACK_IMPORTED_MODULE_1__components_siema__["a" /* default */](SLIDER_PARAMS);
...
function _addToCart(evt) {
  ...
  // Do the post stuff...
  __WEBPACK_IMPORTED_MODULE_2__shop__["a" /* default */].addToCart(id);
  // console.log(id)
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_toast__ = __webpack_require__(260);
...
function addToCart(id) {
  var route = _getRoute('cart', id);
  var msg = 'proizvod je dodat u košaricu';
...
function addToWishlist(id) {
  var route = _getRoute('wishlist', id);
