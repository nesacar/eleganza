            ...
            <div class="panel panel-white">
                ...
                <div class="panel-body">
                    <div class="panel-header-stats">
                        ...
                        <div class="col-sm-4">{!! Form::text('text', \Session::get('sub_email'), array('class' => 'sele')) !!}</div>
                        <div class="col-sm-4">{!! Form::select('language_id', $languages, \Session::get('sub_language_id'), array('class' => 'sele')) !!}</div>
                        <div class="col-sm-4"><input type="submit" value="Pretaga" class="btn btn-success"></div>
                        {!! Form::close() !!}
                    </div>
                </div>
                <div class="panel-body">
