                    ...
                    <div class="widget">
                        ...
                        <div class="col-sm-8">
                            <ul class="nav nav-pills">
                                ...
                                <li><a href="{{ url('admin/statistics/'.$newsletter->id.'/lastDayNewsletter') }}">Juče</a></li>
                                <li><a href="{{ url('admin/statistics/'.$newsletter->id.'/lastMonthNewsletter') }}">Prošlog meseca</a></li>
                                <li @if(!$search) class="active" @endif><a href="{{ url('admin/statistics/'.$newsletter->id.'/lastYearNewsletter') }}">Prošle godine</a></li>
                            </ul>
                        </div>
                        <div class="col-sm-4">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-8 col-sm-6 bordered">
                                        <div class="value-block value-bigger changed-up some-left-padding">
                                            ...
                                            @if($average == 0)
                                                <div class="value-sub">Prosek je manji od jednog klika po mesecu</div>
                                            @elseif($average%10<4)
                                                <div class="value-sub">Prosek od {{ round($sum/12) }} klika po mesecu</div>
                                            @else
                                                <div class="value-sub">Prosek od {{ round($sum/12) }} klikova po mesecu</div>
                                            @endif
                                        </div>
                                    </div>
...
@section('footer_scripts')
    ...
    var data = {
    @if($month == 1)
        labels: ["Februar", "Mart", "April", "Maj", "Jun", "Jul", "Avgust", "Septembar", "Oktobar", "Novembar", "Decembar", "Januar"],
    @elseif($month == 2)
        labels: ["Mart", "April", "Maj", "Jun", "Jul", "Avgust", "Septembar", "Oktobar", "Novembar", "Decembar", "Januar", "Februar"],
    @elseif($month == 3)
        labels: ["April", "Maj", "Jun", "Jul", "Avgust", "Septembar", "Oktobar", "Novembar", "Decembar", "Januar", "Februar", "Mart"],
    @elseif($month == 4)
        labels: ["Maj", "Jun", "Jul", "Avgust", "Septembar", "Oktobar", "Novembar", "Decembar", "Januar", "Februar", "Mart", "April"],
    @elseif($month == 5)
        labels: ["Jun", "Jul", "Avgust", "Septembar", "Oktobar", "Novembar", "Decembar", "Januar", "Februar", "Mart", "April", "Maj"],
    @elseif($month == 6)
        labels: ["Jul", "Avgust", "Septembar", "Oktobar", "Novembar", "Decembar", "Januar", "Februar", "Mart", "April", "Maj", "Jun"],
    @elseif($month == 7)
        labels: ["Avgust", "Septembar", "Oktobar", "Novembar", "Decembar", "Januar", "Februar", "Mart", "April", "Maj", "Jun", "Jul"],
    @elseif($month == 8)
        labels: ["Septembar", "Oktobar", "Novembar", "Decembar", "Januar", "Februar", "Mart", "April", "Maj", "Jun", "Jul", "Avgust"],
    @elseif($month == 9)
        labels: ["Oktobar", "Novembar", "Decembar", "Januar", "Februar", "Mart", "April", "Maj", "Jun", "Jul", "Avgust", "Septembar"],
    @elseif($month == 10)
        labels: ["Novembar", "Decembar", "Januar", "Februar", "Mart", "April", "Maj", "Jun", "Jul", "Avgust", "Septembar", "Oktobar"],
    @elseif($month == 11)
        labels: ["Decembar", "Januar", "Februar", "Mart", "April", "Maj", "Jun", "Jul", "Avgust", "Septembar", "Oktobar", "Novembar"],
    @else
