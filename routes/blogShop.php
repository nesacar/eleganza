...
Route::get('password/reset', 'Auth\LoginController@showLoginForm')->name('login');
...
Route::get('admin/carts/publish/{id}', 'CartsController@publish');
...
Route::post('admin/sets/attributeUpdate/{id}', 'SetsController@attributeUpdate');
Route::post('admin/sets/propertyUpdate/{id}', 'SetsController@propertyUpdate');
Route::get('admin/sets/attributes/{id}', 'SetsController@attributes');
Route::get('admin/sets/properties/{id}', 'SetsController@properties');
Route::resource('admin/sets', 'SetsController');
